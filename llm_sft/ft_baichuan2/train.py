...
from llm_sft.ft_baichuan2.config import CUDA_VISIBLE_DEVICES, USE_TORCH, CPU_NUMS  # from config
...
# from transformers import AutoTokenizer as LLMTokenizer, AutoConfig as LLMConfig
# from transformers import AutoModelForCausalLM as LLMForCausalLM
from llm_sft.models.baichuan2.modeling_baichuan import BaichuanForCausalLM as LLMForCausalLM
from llm_sft.models.baichuan2.tokenization_baichuan import BaichuanTokenizer as LLMTokenizer
from llm_sft.models.baichuan2.configuration_baichuan import BaichuanConfig as LLMConfig
from llm_sft.ft_baichuan2.config import PATH_MODEL_PRETRAIN, DATA_PATH, MODEL_SAVE_DIR, REPO_ID
from llm_sft.ft_baichuan2.config import MICRO_BATCH_SIZE, BATCH_SIZE, GRADIENT_ACCUMULATION_STEPS
from llm_sft.ft_baichuan2.config import LEARNING_RATE, EPOCHS, SAVE_STEPS, VAL_SET_SIZE, TARGET_MODULES
from llm_sft.ft_baichuan2.config import IS_PARALLELIZABLE, MODEL_PARALLEL, USE_CACHE
from llm_sft.ft_baichuan2.config import MAX_LENGTH_Q, MAX_LENGTH_A, MAX_LENGTH_QA
from llm_sft.ft_baichuan2.config import LORA_DROPOUT, LORA_ALPHA, LORA_R
from llm_sft.ft_baichuan2.config import DEEPSPEED_CONF
...
model = LLMForCausalLM.from_pretrained(PATH_MODEL_PRETRAIN,trust_remote_code=True)
...
"""
CUDA_VISIBLE_DEVICES=0,1  deepspeed  train.py
"""